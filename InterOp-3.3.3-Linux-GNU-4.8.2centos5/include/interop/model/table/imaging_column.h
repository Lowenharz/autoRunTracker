...
#define INTEROP_IMAGING_COLUMN_TYPES \
        ...
        /** IUO **/ \
        INTEROP_TUPLE7(AffineTransform,        metrics::registration_metric,       affine_transform,           Void, Float, AffineTransformArray, 5)\
        INTEROP_TUPLE7(SubtileOffsets,         metrics::registration_metric,       sub_tile_offsets,           Void, Float, SubTileOffsetArray, 5)\
        INTEROP_TUPLE7(UpperLeftOffset,        metrics::extended_tile_metric,      upper_left,                 Void, Float, UpperLeftPoint, 5)\
        INTEROP_TUPLE7(ColorMatrix,            metrics::color_matrix_metric,       color_matrix,               Void, Float, ColorMatrixArray, 3)\
        INTEROP_TUPLE7(ClusterCountOccupiedK,  metrics::extended_tile_metric,      cluster_count_occupied_k,   Void, Float, ValueType, 1)\
        INTEROP_TUPLE7(PercentOccupied,        metrics::extended_tile_metric,      percent_occupied,           ClusterCountK, Float, ValueType, 1)\
        INTEROP_TUPLE7(CloudCentroid,          metrics::basecalling_metric,        centroids,                  Void, Float, BaseXYArray, 3)\
        INTEROP_TUPLE7(ConfusionMatrix,        metrics::alignment_metric,          confusion_matrix,           Void, UInt, Base2DArray, 3)\
        INTEROP_TUPLE7(MaxResidualError,       metrics::registration_metric,       max_residual_radial_errors, Void, Float, ChannelArray, 5)\
        INTEROP_TUPLE7(CloudDeterminant,       metrics::basecalling_metric,        mean_determinant,           Void, Float, ValueType, 5)
