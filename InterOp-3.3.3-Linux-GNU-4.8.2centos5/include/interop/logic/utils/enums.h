...
/** This macro maps an enum description to a string/enum pair */
#define INTEROP_TUPLE_FEATURE(X, IGNORED_1) name_type_pair_t(#X,X)
/** This macro maps an enum description to a string/enum pair */
#define INTEROP_TUPLE_ASSIGN_AND_FEATURE(X, IGNORED_1, IGNORED_2) name_type_pair_t(#X,X)
...
namespace illumina { namespace interop {  namespace constants
{
    ...
    /** Specialization that maps affine transform components to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<affine_transform_type >
    {
        typedef std::pair<std::string, affine_transform_type> name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_AFFINE_TRANSFORM_TYPES};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps sub-tile region names to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<sub_tile_region_name >
    {
        typedef std::pair<std::string, sub_tile_region_name> name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_SUB_TILE_REGION_NAMES};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps sub-tile offset components to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<sub_tile_offset_type >
    {
        typedef std::pair<std::string, sub_tile_offset_type> name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_SUB_TILE_OFFSET_TYPES};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps event types to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<event_type>
    {
        typedef std::pair<std::string, event_type> name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_EVENT_TYPE};
            return func(name_types, util::length_of(name_types));
        }
    };

    /** Specialization that maps distortion types to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<distortion_type >
    {
        typedef std::pair<std::string, distortion_type > name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_DISTORTION_TYPE};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps distortion curve types to a string
     ...
     */
    template<>
    class enumeration_string_mapping< distortion_curve_type >
    {
        typedef std::pair<std::string, distortion_curve_type > name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_DISTORTION_CURVE_TYPE};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps run diagnostic issue types to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<run_diagnostics_issue_type >
    {
        typedef std::pair<std::string, run_diagnostics_issue_type > name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_RUN_DIAGNOSTICS_ISSUE_TYPE};
            return func(name_types, util::length_of(name_types));
        }
    };
    /** Specialization that maps layout type types to a string
     * @note IUO
     */
    template<>
    class enumeration_string_mapping<layout_type >
    {
        typedef std::pair<std::string, layout_type > name_type_pair_t;
    public:
        /** Pass an array of string, enum pairs and its length to the given function
         *
         * @param func pointer to a function that takes an array of string/enum pairs as a parameter
        ...
        static R setup(F func)
        {
            static const name_type_pair_t name_types[] = {INTEROP_ENUM_LAYOUT_TYPE};
            return func(name_types, util::length_of(name_types));
        }
    };
}}}
