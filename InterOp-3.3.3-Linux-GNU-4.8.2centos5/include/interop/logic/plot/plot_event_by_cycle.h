...
{
    /** Plot all event interval timings by cycle
     *
     * @ingroup plot_logic
     ...
     */
    void plot_event_by_cycle(model::metrics::run_metrics &metrics,
    ...
    /** List all event types that are associated with time intervals
     *
     * @param types destination vector to fill with event types
     */
    void list_interval_events(std::vector< constants::event_type >& types);
}}}}
