...
setup(
    ...
    url='https://git.illumina.com/Bioinformatics/interop',
    license='Illumina Use Only',
    download_url='https://ussd.artifactory.illumina.com/list/generic-bioinformatics/interop/',
    packages=['interop'],
