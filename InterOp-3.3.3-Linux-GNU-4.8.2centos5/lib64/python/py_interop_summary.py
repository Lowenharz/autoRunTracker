...
class stat_summary(_object):
    ...
    def __init__(self, channel_count):
        this = _py_interop_summary.new_stat_summary(channel_count)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def percent_gt_q30_last_10_cycles(self, *args):
        return _py_interop_summary.stat_summary_percent_gt_q30_last_10_cycles(self, *args)

    def fwhm(self, *args):
        return _py_interop_summary.stat_summary_fwhm(self, *args)

    def percent_base(self, *args):
        return _py_interop_summary.stat_summary_percent_base(self, *args)

    def percent_occupied(self, *args):
        return _py_interop_summary.stat_summary_percent_occupied(self, *args)

    def theta_z(self, *args):
        return _py_interop_summary.stat_summary_theta_z(self, *args)

    def theta(self, *args):
        return _py_interop_summary.stat_summary_theta(self, *args)

    def resize_stat(self, channel_count):
        return _py_interop_summary.stat_summary_resize_stat(self, channel_count)
...
class metric_summary(_object):
    ...
    def __init__(self, channel_count):
        this = _py_interop_summary.new_metric_summary(channel_count)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def percent_gt_q30_last_10_cycles(self, *args):
        return _py_interop_summary.metric_summary_percent_gt_q30_last_10_cycles(self, *args)

    def percent_occupied(self, *args):
        return _py_interop_summary.metric_summary_percent_occupied(self, *args)

    def theta_z(self, *args):
        return _py_interop_summary.metric_summary_theta_z(self, *args)

    def theta(self, *args):
        return _py_interop_summary.metric_summary_theta(self, *args)

    def percent_pf(self):
        return _py_interop_summary.metric_summary_percent_pf(self)

    def fwhm(self, *args):
        return _py_interop_summary.metric_summary_fwhm(self, *args)

    def resynthesis(self, *args):
        return _py_interop_summary.metric_summary_resynthesis(self, *args)

    def percent_base(self, *args):
        return _py_interop_summary.metric_summary_percent_base(self, *args)

    def phasing(self, *args):
        return _py_interop_summary.metric_summary_phasing(self, *args)

    def prephasing(self, *args):
        return _py_interop_summary.metric_summary_prephasing(self, *args)

    def percent_no_call(self, *args):
        return _py_interop_summary.metric_summary_percent_no_call(self, *args)

    def cluster_density(self, *args):
        return _py_interop_summary.metric_summary_cluster_density(self, *args)

    def cluster_density_pf(self, *args):
        return _py_interop_summary.metric_summary_cluster_density_pf(self, *args)

    def resize(self, channel_count):
        return _py_interop_summary.metric_summary_resize(self, channel_count)
...
class metric_stat(_object):
    ...
    def clear(self, set_nan=False):
        return _py_interop_summary.metric_stat_clear(self, set_nan)
...
class compass_cycle_table(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, compass_cycle_table, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, compass_cycle_table, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _py_interop_summary.new_compass_cycle_table()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def resize(self, row_count, col_count):
        return _py_interop_summary.compass_cycle_table_resize(self, row_count, col_count)

    def at(self, row, col):
        return _py_interop_summary.compass_cycle_table_at(self, row, col)

    def column_at(self, *args):
        return _py_interop_summary.compass_cycle_table_column_at(self, *args)

    def column_count(self):
        return _py_interop_summary.compass_cycle_table_column_count(self)

    def row_count(self):
        return _py_interop_summary.compass_cycle_table_row_count(self)
    __swig_destroy__ = _py_interop_summary.delete_compass_cycle_table
    __del__ = lambda self: None
compass_cycle_table_swigregister = _py_interop_summary.compass_cycle_table_swigregister
compass_cycle_table_swigregister(compass_cycle_table)


def summarize_compass_run_metrics(metrics, summary, skip_median=False, clear=True):
    return _py_interop_summary.summarize_compass_run_metrics(metrics, summary, skip_median, clear)
summarize_compass_run_metrics = _py_interop_summary.summarize_compass_run_metrics

def summarize_compass_cycle_metrics(metrics, table):
    return _py_interop_summary.summarize_compass_cycle_metrics(metrics, table)
summarize_compass_cycle_metrics = _py_interop_summary.summarize_compass_cycle_metrics
