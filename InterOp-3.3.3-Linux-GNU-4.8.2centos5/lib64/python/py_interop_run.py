...
class rfid_metadata(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, rfid_metadata, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, rfid_metadata, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _py_interop_run.new_rfid_metadata(*args)
        try:
    ...
    def expiration_date(self):
        return _py_interop_run.rfid_metadata_expiration_date(self)

    def part_number(self):
        return _py_interop_run.rfid_metadata_part_number(self)

    def serial_number(self):
        return _py_interop_run.rfid_metadata_serial_number(self)
    __swig_destroy__ = _py_interop_run.delete_rfid_metadata
    __del__ = lambda self: None
rfid_metadata_swigregister = _py_interop_run.rfid_metadata_swigregister
rfid_metadata_swigregister(rfid_metadata)
...
MinContrast = _py_interop_run.MinContrast
MaxContrast = _py_interop_run.MaxContrast
SubtilePFPercent = _py_interop_run.SubtilePFPercent
SubtileClustersPF = _py_interop_run.SubtileClustersPF
SubtileDensityPF = _py_interop_run.SubtileDensityPF
SubtileFwhm = _py_interop_run.SubtileFwhm
SubtileQ30Percent = _py_interop_run.SubtileQ30Percent
SubtileDensity = _py_interop_run.SubtileDensity
SubtileClusters = _py_interop_run.SubtileClusters
DistortionByTile = _py_interop_run.DistortionByTile
EventByCycle = _py_interop_run.EventByCycle
EventByType = _py_interop_run.EventByType
MaxResidualR = _py_interop_run.MaxResidualR
Theta = _py_interop_run.Theta
ThetaZ = _py_interop_run.ThetaZ
...
Event = _py_interop_run.Event
Registration = _py_interop_run.Registration
BaseCalling = _py_interop_run.BaseCalling
Alignment = _py_interop_run.Alignment
PFGrid = _py_interop_run.PFGrid
QGrid = _py_interop_run.QGrid
FWHMGrid = _py_interop_run.FWHMGrid
StaticRun = _py_interop_run.StaticRun
ColorMatrix = _py_interop_run.ColorMatrix
OpticalModel = _py_interop_run.OpticalModel
RunDiagnostics = _py_interop_run.RunDiagnostics
...
BaseEventV1Type = _py_interop_run.BaseEventV1Type
BaseEventV2Type = _py_interop_run.BaseEventV2Type
...
UpperLeftPoint = _py_interop_run.UpperLeftPoint
AffineTransformArray = _py_interop_run.AffineTransformArray
SubTileOffsetArray = _py_interop_run.SubTileOffsetArray
BaseXYArray = _py_interop_run.BaseXYArray
Base2DArray = _py_interop_run.Base2DArray
ColorMatrixArray = _py_interop_run.ColorMatrixArray
RunDiagnosticsArray = _py_interop_run.RunDiagnosticsArray
...
SubtileFeature = _py_interop_run.SubtileFeature
IUOFeature = _py_interop_run.IUOFeature
IntervalFeature = _py_interop_run.IntervalFeature
...
DistortionByTilePlot = _py_interop_run.DistortionByTilePlot
SubTileAggregateXPlot = _py_interop_run.SubTileAggregateXPlot
SubTileAggregateYPlot = _py_interop_run.SubTileAggregateYPlot
SubTileFlowCellPlot = _py_interop_run.SubTileFlowCellPlot
EventByCyclePlot = _py_interop_run.EventByCyclePlot
EventByTypePlot = _py_interop_run.EventByTypePlot
UnknownPlotType = _py_interop_run.UnknownPlotType
TranslationX = _py_interop_run.TranslationX
TranslationY = _py_interop_run.TranslationY
MagnificationX = _py_interop_run.MagnificationX
MagnificationY = _py_interop_run.MagnificationY
ShearXY = _py_interop_run.ShearXY
ShearYX = _py_interop_run.ShearYX
AffineTransformComponentCount = _py_interop_run.AffineTransformComponentCount
UnknownAffineTransformType = _py_interop_run.UnknownAffineTransformType
OffsetX = _py_interop_run.OffsetX
OffsetY = _py_interop_run.OffsetY
Score = _py_interop_run.Score
SubTileOffsetComponentCount = _py_interop_run.SubTileOffsetComponentCount
UnknownSubTileOffsetType = _py_interop_run.UnknownSubTileOffsetType
NNW = _py_interop_run.NNW
NNE = _py_interop_run.NNE
NW = _py_interop_run.NW
NE = _py_interop_run.NE
SW = _py_interop_run.SW
SE = _py_interop_run.SE
SSW = _py_interop_run.SSW
SSE = _py_interop_run.SSE
SubTileRegionCount = _py_interop_run.SubTileRegionCount
UnknownSubTileRegionName = _py_interop_run.UnknownSubTileRegionName
RtaStarted = _py_interop_run.RtaStarted
CycleStarted = _py_interop_run.CycleStarted
TemplateGenerationStarted = _py_interop_run.TemplateGenerationStarted
TemplateGenerationCompleted = _py_interop_run.TemplateGenerationCompleted
PostTemplateMaxClustersInit = _py_interop_run.PostTemplateMaxClustersInit
SystemMemoryAvailableGigabyte = _py_interop_run.SystemMemoryAvailableGigabyte
RegistrationAndExtraction = _py_interop_run.RegistrationAndExtraction
NeighborCorrection = _py_interop_run.NeighborCorrection
ColorMatrixCorrection = _py_interop_run.ColorMatrixCorrection
TemplateGeneration = _py_interop_run.TemplateGeneration
BasecallingAndQualityScoring = _py_interop_run.BasecallingAndQualityScoring
SequenceAlignment = _py_interop_run.SequenceAlignment
BclWriting = _py_interop_run.BclWriting
ReadStarted = _py_interop_run.ReadStarted
ReadCompleted = _py_interop_run.ReadCompleted
FilterAlignStarted = _py_interop_run.FilterAlignStarted
FilterAlignCompleted = _py_interop_run.FilterAlignCompleted
CycleCompleted = _py_interop_run.CycleCompleted
RtaCompleted = _py_interop_run.RtaCompleted
IntensityFileReading = _py_interop_run.IntensityFileReading
IntensityFileWriting = _py_interop_run.IntensityFileWriting
TemplateGenerationImageStored = _py_interop_run.TemplateGenerationImageStored
RegistrationDuration = _py_interop_run.RegistrationDuration
ExtractionDuration = _py_interop_run.ExtractionDuration
SpatialNormalizationDuration = _py_interop_run.SpatialNormalizationDuration
PhasingCorrectionDuration = _py_interop_run.PhasingCorrectionDuration
RtaReadyToProcess = _py_interop_run.RtaReadyToProcess
CalibrateDistortionDuration = _py_interop_run.CalibrateDistortionDuration
FocusEstimationDuration = _py_interop_run.FocusEstimationDuration
AddBCLDuration = _py_interop_run.AddBCLDuration
AddFilterFileDuration = _py_interop_run.AddFilterFileDuration
WriteThumbNailDuration = _py_interop_run.WriteThumbNailDuration
WriteFullImageDuration = _py_interop_run.WriteFullImageDuration
SharpeningDuration = _py_interop_run.SharpeningDuration
BasecallReportingDuration = _py_interop_run.BasecallReportingDuration
EventTypeCount = _py_interop_run.EventTypeCount
BasecallingAndQualityScoringDuration = _py_interop_run.BasecallingAndQualityScoringDuration
SequenceAlignmentDuration = _py_interop_run.SequenceAlignmentDuration
UnknownEvent = _py_interop_run.UnknownEvent
XFieldOfViewYDistortion = _py_interop_run.XFieldOfViewYDistortion
XFieldOfViewXDistortion = _py_interop_run.XFieldOfViewXDistortion
Radial = _py_interop_run.Radial
UnknownDistortion = _py_interop_run.UnknownDistortion
DistortionXonX = _py_interop_run.DistortionXonX
DistortionXYonX = _py_interop_run.DistortionXYonX
UnknownDistortionCurve = _py_interop_run.UnknownDistortionCurve
AllIssues = _py_interop_run.AllIssues
DeadTile = _py_interop_run.DeadTile
BlankImage = _py_interop_run.BlankImage
FailedCycle = _py_interop_run.FailedCycle
QOutliers = _py_interop_run.QOutliers
RunDiagnosticsIssueCount = _py_interop_run.RunDiagnosticsIssueCount
UnknownRunDiagnosticsIssueType = _py_interop_run.UnknownRunDiagnosticsIssueType
SquareLayout = _py_interop_run.SquareLayout
HexLayout = _py_interop_run.HexLayout
LayoutCount = _py_interop_run.LayoutCount
UnknownLayout = _py_interop_run.UnknownLayout
...
class info(_object):
    ...
    def validate_cycle(self, lane, tile, cycle):
        return _py_interop_run.info_validate_cycle(self, lane, tile, cycle)

    def validate_read(self, lane, tile, read):
        return _py_interop_run.info_validate_read(self, lane, tile, read)
    ...
    def write(self, *args):
        return _py_interop_run.info_write(self, *args)
...
class parameters(_object):
    ...
    def instrument_name(self):
        return _py_interop_run.parameters_instrument_name(self)

    def instrument_type(self):
        return _py_interop_run.parameters_instrument_type(self)

    def experiment_name(self):
        return _py_interop_run.parameters_experiment_name(self)

    def chemistry(self):
        return _py_interop_run.parameters_chemistry(self)

    def control_lane(self):
        return _py_interop_run.parameters_control_lane(self)

    def version(self):
        return _py_interop_run.parameters_version(self)

    def flowcell_rfid(self):
        return _py_interop_run.parameters_flowcell_rfid(self)

    def bottle_rfid(self):
        return _py_interop_run.parameters_bottle_rfid(self)

    def bottle_barcode(self):
        return _py_interop_run.parameters_bottle_barcode(self)

    def reagent_rfid(self):
        return _py_interop_run.parameters_reagent_rfid(self)

    def reagent_barcode(self):
        return _py_interop_run.parameters_reagent_barcode(self)
    ...
    if _newclass:
        parse_time = staticmethod(_py_interop_run.parameters_parse_time)
    else:
        parse_time = _py_interop_run.parameters_parse_time
...
def parameters_parse_time(time_repr):
    return _py_interop_run.parameters_parse_time(time_repr)
parameters_parse_time = _py_interop_run.parameters_parse_time
...
class event_type_vector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, event_type_vector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, event_type_vector, name)
    __repr__ = _swig_repr
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _py_interop_run.event_type_vector___nonzero__(self)

    def __bool__(self):
        return _py_interop_run.event_type_vector___bool__(self)

    def __len__(self):
        return _py_interop_run.event_type_vector___len__(self)

    def __getslice__(self, i, j):
        return _py_interop_run.event_type_vector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _py_interop_run.event_type_vector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _py_interop_run.event_type_vector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _py_interop_run.event_type_vector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _py_interop_run.event_type_vector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _py_interop_run.event_type_vector___setitem__(self, *args)

    def pop(self):
        return _py_interop_run.event_type_vector_pop(self)

    def append(self, x):
        return _py_interop_run.event_type_vector_append(self, x)

    def empty(self):
        return _py_interop_run.event_type_vector_empty(self)

    def size(self):
        return _py_interop_run.event_type_vector_size(self)

    def swap(self, v):
        return _py_interop_run.event_type_vector_swap(self, v)

    def rbegin(self):
        return _py_interop_run.event_type_vector_rbegin(self)

    def rend(self):
        return _py_interop_run.event_type_vector_rend(self)

    def clear(self):
        return _py_interop_run.event_type_vector_clear(self)

    def get_allocator(self):
        return _py_interop_run.event_type_vector_get_allocator(self)

    def pop_back(self):
        return _py_interop_run.event_type_vector_pop_back(self)

    def erase(self, *args):
        return _py_interop_run.event_type_vector_erase(self, *args)

    def __init__(self, *args):
        this = _py_interop_run.new_event_type_vector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _py_interop_run.event_type_vector_push_back(self, x)

    def front(self):
        return _py_interop_run.event_type_vector_front(self)

    def back(self):
        return _py_interop_run.event_type_vector_back(self)

    def assign(self, n, x):
        return _py_interop_run.event_type_vector_assign(self, n, x)

    def resize(self, *args):
        return _py_interop_run.event_type_vector_resize(self, *args)

    def insert(self, *args):
        return _py_interop_run.event_type_vector_insert(self, *args)

    def reserve(self, n):
        return _py_interop_run.event_type_vector_reserve(self, n)

    def capacity(self):
        return _py_interop_run.event_type_vector_capacity(self)
    __swig_destroy__ = _py_interop_run.delete_event_type_vector
    __del__ = lambda self: None
event_type_vector_swigregister = _py_interop_run.event_type_vector_swigregister
event_type_vector_swigregister(event_type_vector)
...
def list_sub_tile_offset_type(vec, skip=0):
    return _py_interop_run.list_sub_tile_offset_type(vec, skip)
list_sub_tile_offset_type = _py_interop_run.list_sub_tile_offset_type

def parse_sub_tile_offset_type(name):
    return _py_interop_run.parse_sub_tile_offset_type(name)
parse_sub_tile_offset_type = _py_interop_run.parse_sub_tile_offset_type

def to_string_sub_tile_offset_type(value):
    return _py_interop_run.to_string_sub_tile_offset_type(value)
to_string_sub_tile_offset_type = _py_interop_run.to_string_sub_tile_offset_type

def list_sub_tile_region_name(vec, skip=0):
    return _py_interop_run.list_sub_tile_region_name(vec, skip)
list_sub_tile_region_name = _py_interop_run.list_sub_tile_region_name

def parse_sub_tile_region_name(name):
    return _py_interop_run.parse_sub_tile_region_name(name)
parse_sub_tile_region_name = _py_interop_run.parse_sub_tile_region_name

def to_string_sub_tile_region_name(value):
    return _py_interop_run.to_string_sub_tile_region_name(value)
to_string_sub_tile_region_name = _py_interop_run.to_string_sub_tile_region_name

def list_affine_transform_type(vec, skip=0):
    return _py_interop_run.list_affine_transform_type(vec, skip)
list_affine_transform_type = _py_interop_run.list_affine_transform_type

def parse_affine_transform_type(name):
    return _py_interop_run.parse_affine_transform_type(name)
parse_affine_transform_type = _py_interop_run.parse_affine_transform_type

def to_string_affine_transform_type(value):
    return _py_interop_run.to_string_affine_transform_type(value)
to_string_affine_transform_type = _py_interop_run.to_string_affine_transform_type

def list_event_type(vec, skip=0):
    return _py_interop_run.list_event_type(vec, skip)
list_event_type = _py_interop_run.list_event_type

def parse_event_type(name):
    return _py_interop_run.parse_event_type(name)
parse_event_type = _py_interop_run.parse_event_type

def to_string_event_type(value):
    return _py_interop_run.to_string_event_type(value)
to_string_event_type = _py_interop_run.to_string_event_type

def list_distortion_type(vec, skip=0):
    return _py_interop_run.list_distortion_type(vec, skip)
list_distortion_type = _py_interop_run.list_distortion_type

def parse_distortion_type(name):
    return _py_interop_run.parse_distortion_type(name)
parse_distortion_type = _py_interop_run.parse_distortion_type

def to_string_distortion_type(value):
    return _py_interop_run.to_string_distortion_type(value)
to_string_distortion_type = _py_interop_run.to_string_distortion_type

def list_distortion_curve_type(vec, skip=0):
    return _py_interop_run.list_distortion_curve_type(vec, skip)
list_distortion_curve_type = _py_interop_run.list_distortion_curve_type

def parse_distortion_curve_type(name):
    return _py_interop_run.parse_distortion_curve_type(name)
parse_distortion_curve_type = _py_interop_run.parse_distortion_curve_type

def to_string_distortion_curve_type(value):
    return _py_interop_run.to_string_distortion_curve_type(value)
to_string_distortion_curve_type = _py_interop_run.to_string_distortion_curve_type
