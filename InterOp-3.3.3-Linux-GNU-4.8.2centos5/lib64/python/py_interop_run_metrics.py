...
def to_event_feature(type):
    return _py_interop_run_metrics.to_event_feature(type)
to_event_feature = _py_interop_run_metrics.to_event_feature

def is_subtile_metric(type):
    return _py_interop_run_metrics.is_subtile_metric(type)
is_subtile_metric = _py_interop_run_metrics.is_subtile_metric

def is_interval_event(type):
    return _py_interop_run_metrics.is_interval_event(type)
is_interval_event = _py_interop_run_metrics.is_interval_event

def is_iuo_metric(type):
    return _py_interop_run_metrics.is_iuo_metric(type)
is_iuo_metric = _py_interop_run_metrics.is_iuo_metric

def is_iuo(type):
    return _py_interop_run_metrics.is_iuo(type)
is_iuo = _py_interop_run_metrics.is_iuo

def list_metrics_to_load_metric_group(group, valid_to_load, instrument, is_iuo):
    return _py_interop_run_metrics.list_metrics_to_load_metric_group(group, valid_to_load, instrument, is_iuo)
list_metrics_to_load_metric_group = _py_interop_run_metrics.list_metrics_to_load_metric_group

def list_metrics_to_load_metric_groups(groups, valid_to_load, instrument, is_iuo):
    return _py_interop_run_metrics.list_metrics_to_load_metric_groups(groups, valid_to_load, instrument, is_iuo)
...
def list_summary_metric_groups(groups, instrument, show_iuo=False):
    return _py_interop_run_metrics.list_summary_metric_groups(groups, instrument, show_iuo)
...
def list_analysis_metrics_to_load(valid_to_load, show_iuo=False):
    return _py_interop_run_metrics.list_analysis_metrics_to_load(valid_to_load, show_iuo)
list_analysis_metrics_to_load = _py_interop_run_metrics.list_analysis_metrics_to_load

def list_event_metrics_to_load(valid_to_load):
    return _py_interop_run_metrics.list_event_metrics_to_load(valid_to_load)
list_event_metrics_to_load = _py_interop_run_metrics.list_event_metrics_to_load

def list_subtile_metrics_to_load(valid_to_load):
    return _py_interop_run_metrics.list_subtile_metrics_to_load(valid_to_load)
list_subtile_metrics_to_load = _py_interop_run_metrics.list_subtile_metrics_to_load

def list_run_diagnostics_metrics_to_load(valid_to_load):
    return _py_interop_run_metrics.list_run_diagnostics_metrics_to_load(valid_to_load)
list_run_diagnostics_metrics_to_load = _py_interop_run_metrics.list_run_diagnostics_metrics_to_load

def list_run_diagnostics_metric_groups(groups):
    return _py_interop_run_metrics.list_run_diagnostics_metric_groups(groups)
list_run_diagnostics_metric_groups = _py_interop_run_metrics.list_run_diagnostics_metric_groups
class run_metrics(_object):
    ...
    def set_alignment_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_alignment_metric_set(self, metrics)

    def alignment_metric_set(self):
        return _py_interop_run_metrics.run_metrics_alignment_metric_set(self)

    def set_basecalling_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_basecalling_metric_set(self, metrics)

    def basecalling_metric_set(self):
        return _py_interop_run_metrics.run_metrics_basecalling_metric_set(self)

    def set_color_matrix_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_color_matrix_metric_set(self, metrics)

    def color_matrix_metric_set(self):
        return _py_interop_run_metrics.run_metrics_color_matrix_metric_set(self)

    def set_distortion_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_distortion_metric_set(self, metrics)

    def distortion_metric_set(self):
        return _py_interop_run_metrics.run_metrics_distortion_metric_set(self)

    def set_dynamic_phasing_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_dynamic_phasing_metric_set(self, metrics)

    def dynamic_phasing_metric_set(self):
        return _py_interop_run_metrics.run_metrics_dynamic_phasing_metric_set(self)

    def set_event_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_event_metric_set(self, metrics)

    def event_metric_set(self):
        return _py_interop_run_metrics.run_metrics_event_metric_set(self)
    ...
    def set_fwhm_grid_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_fwhm_grid_metric_set(self, metrics)

    def fwhm_grid_metric_set(self):
        return _py_interop_run_metrics.run_metrics_fwhm_grid_metric_set(self)

    def set_pf_grid_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_pf_grid_metric_set(self, metrics)

    def pf_grid_metric_set(self):
        return _py_interop_run_metrics.run_metrics_pf_grid_metric_set(self)

    def set_phasing_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_phasing_metric_set(self, metrics)

    def phasing_metric_set(self):
        return _py_interop_run_metrics.run_metrics_phasing_metric_set(self)

    def set_q_grid_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_q_grid_metric_set(self, metrics)

    def q_grid_metric_set(self):
        return _py_interop_run_metrics.run_metrics_q_grid_metric_set(self)

    def set_registration_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_registration_metric_set(self, metrics)

    def registration_metric_set(self):
        return _py_interop_run_metrics.run_metrics_registration_metric_set(self)

    def set_run_diagnostics_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_run_diagnostics_metric_set(self, metrics)

    def run_diagnostics_metric_set(self):
        return _py_interop_run_metrics.run_metrics_run_diagnostics_metric_set(self)

    def set_static_run_metric_set(self, metrics):
        return _py_interop_run_metrics.run_metrics_set_static_run_metric_set(self, metrics)

    def static_run_metric_set(self):
        return _py_interop_run_metrics.run_metrics_static_run_metric_set(self)
